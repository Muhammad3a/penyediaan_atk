...
use App\Filament\Resources\PersediaanAtkResource\Pages;
use App\Filament\Resources\PersediaanAtkResource\RelationManagers;
...
class PersediaanAtkResource extends Resource
{
    protected static ?string $model = PersediaanAtk::class;
    ...
    {
        return [
            'index' => Pages\ListPersediaanAtks::route('/'),
            'create' => Pages\CreatePersediaanAtk::route('/create'),
            'edit' => Pages\EditPersediaanAtk::route('/{record}/edit'),
        ];
    }        
